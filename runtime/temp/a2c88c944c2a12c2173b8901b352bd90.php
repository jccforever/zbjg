<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/zbjg/public/../application/admin/view/supplier/supplier/edit.html";i:1606813927;s:60:"/www/wwwroot/zbjg/application/admin/view/layout/default.html";i:1606813927;s:57:"/www/wwwroot/zbjg/application/admin/view/common/meta.html";i:1606813927;s:59:"/www/wwwroot/zbjg/application/admin/view/common/script.html";i:1606813927;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-supplier_sn" data-rule="required" class="form-control" name="row[supplier_sn]" type="text" value="<?php echo htmlentities($row['supplier_sn']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Supplier_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-supplier_name" data-rule="required" class="form-control" name="row[supplier_name]" type="text" value="<?php echo htmlentities($row['supplier_name']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-linkman" data-rule="required" class="form-control" name="row[linkman]" type="text" value="<?php echo htmlentities($row['linkman']); ?>">
        </div>
    </div>
    <div class="form-group">
